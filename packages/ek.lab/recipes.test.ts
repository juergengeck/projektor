...
test("constructors produce typed objects", () => {
  ...
  assert.equal(createOrder({ department: HASH, idempotencyKey: "k1", customer: PERSON, seller: PERSON, offer: "o1", quantity: 2, lot: "ek-lot-a", facility: "ek-facility", admittedAt: 1 }).quantity, 2);
});
